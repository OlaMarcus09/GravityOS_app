...
- `0024_retention_checkins.sql` (applied 2026-08-10)
...
11. Manually dispatch the notification cycle and verify activation, digest, and
    dormant-check-in outbox rows with a disposable account.
